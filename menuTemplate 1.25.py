...
button_ON = Button("ON", (SCREENWIDTH/2, SCREENHEIGHT/4), my_next_function,bg=RED)
button_OFF= Button("OFF", (SCREENWIDTH/2, SCREENHEIGHT*2/4),my_next_function, bg=GREEN)


#arrange button groups depending on level
level1_buttons = [button_HELLO,button_SETTINGS, button_QUIT]
level2_buttons = [button_Previous,button_Sound]
level3_buttons = [button_ON,button_OFF,button_QUIT]  
#---------Main Program Loop----------
while carryOn:
    # --- Main event loop ---
